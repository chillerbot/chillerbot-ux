...
GFX_FILES = [
	...
	["src/engine/client/backend_sdl.cpp", ["CGraphicsBackend_Threaded", "CCommandProcessorFragment_General", "CCommandProcessorFragment_SDL", "CCommandProcessor_SDL_OpenGL", "CGraphicsBackend_SDL_OpenGL"]],
	["src/engine/client/textrender.cpp", ["CGlyphMap::CAtlas", "CGlyphMap", "CTextRender"]],
]

GFX_IN_CLASS = [["src/engine/client/text.cpp", "CTextRender"]]
	...
	with open(filename, encoding="utf8") as file:
		for line in file:
			...
			for class_name in class_names:
				for func_type in ("void", "bool", "const char", "int", "vec2", "ivec2", "ivec3", "IGraphics::CTextureHandle", "CWordWidthHint"):
...
def main():
	"""main method"""
	parser = argparse.ArgumentParser(description="Comment out the graphic code to get a headless client")
	parser.add_argument("-i", "--inplace", action="store_true", help="Edit files in place instead of printing to stdout")
