...
#include <utility> // chillerbot-ux std::move
...
void CMapLayers::OnMapLoad()
{
	...
	RefreshTileBuffers(ProgressBarCallback);
}

void CMapLayers::RefreshTileBuffers(std::optional<FCallbackMapRendererInit> ProgressBarCallback)
{
	...
	m_MapRenderer.Load(m_Type, m_pLayers, m_pImages, &m_EnvEvaluator, std::move(ProgressBarCallback));
}
